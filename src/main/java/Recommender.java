...
public class Recommender {
    ...
    public Recommender(ParameterTool params, ExecutionEnvironment env) {
        this.params = params;
        this.env = env;
    ...
    public static final class recommenderMap implements FlatMapFunction<PrimitiveData, Result> {
        public void flatMap(PrimitiveData primitiveData, Collector<Result> collector) throws Exception {
            ...
            int topK = 3;
            List<SimilarityTuple> recommendNearestNeighbors = Tools.userBasedRecommend(trainResult, visibleObjSet, 3);
